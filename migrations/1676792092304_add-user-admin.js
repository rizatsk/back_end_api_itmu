exports.up = (pgm) => {
  pgm.sql(`INSERT INTO auth_role VALUES
    ('1', 'admin', '{}', '2022-05-30 13:06:49', 'admin-00000001', '2022-05-30 13:06:49', 'admin-00000001')`);
  ...
  pgm.sql(`INSERT INTO user_admins VALUES('admin-00000002', 'Rizat service', 
      ...
      'admin-00000001', '2023-02-20 13:06:49', 'admin-00000001', true, '1')`);
};

exports.down = (pgm) => {
  // pgm.sql("DROP table user_admins");
  pgm.sql(`DELETE FROM user_admins WHERE admin_id = 'admin-00000002'`);
  pgm.sql(`DELETE FROM auth_role WHERE role_id = '1'`);
};
