class PackageServiceHandler {
  constructor(service, logActivityService, validator) {
    ...
    this.getPackageServiceByIdHandler = this.getPackageServiceByIdHandler.bind(this);
    this.getPackageServiceHandler = this.getPackageServiceHandler.bind(this);
    this.putPackgeServiceByIdHandler = this.putPackgeServiceByIdHandler.bind(this);
    this.putStatusPackageServiceByIdHandler = this.putStatusPackageServiceByIdHandler.bind(this);
  }
