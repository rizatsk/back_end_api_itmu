...
class ProductServiceHandler {
    ...
    async postProductServiceHandler(request) {
        ...
        await this._lock.acquire("data", async () => {
            ...
            const productServiceId = await this._service.addProductService(request.payload);
    ...
    async getProductServiceByIdHandler(request) {
        ...
        const productService = await this._service.getProductServiceById(productServiceId);
